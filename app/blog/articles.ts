...
export const ARTICLES: Article[] = [
  ...
  },
  {
    ...
    excerpt: 'The same appliance wattages and per-kVA prices our calculator uses, plus a worked example that lands on the same inverter size the calculator would give you.',
    readTime: '7 min read',
    date: 'September 2026',
    tag: 'System Sizing',
  ...
  },
  {
    ...
    excerpt: 'Good news: solar is remarkably low-maintenance. Here\'s what you actually need to do — and what you can safely ignore — with battery replacement costs computed, not guessed.',
    readTime: '7 min read',
    date: 'September 2026',
    tag: 'Maintenance',
  ...
  },
  {
    ...
    excerpt: 'Compare the best solar financing options in Nigeria — fintech loans, bank products, PAYG schemes, and installer payment plans — with repayment maths run against two real, computed system prices.',
    readTime: '8 min read',
    date: 'September 2026',
    tag: 'Financing',

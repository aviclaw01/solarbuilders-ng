    ...
    <div className="mt-3 bg-white border border-[#E2E8F0] rounded-2xl overflow-hidden">
      ...
      {open && (
        <div className="px-4 pb-4">
              ...
              <div key={o.lender.slug} className="border border-[#E2E8F0] rounded-xl p-3">
                <div className="flex items-start justify-between gap-3 mb-1">
                  ...
                  <div className="text-right flex-shrink-0">
                    <p className="font-heading font-extrabold text-[#F59E0B] text-base leading-tight">
                      {formatNaira(o.monthly)}
                    </p>
                    <p className="text-[10px] text-[#94A3B8]">/month × {o.months}</p>
                  </div>
                </div>
                ...
                <a
                  ...
                  className="inline-flex items-center gap-1 text-xs font-semibold text-amber-600 hover:underline mt-2"
                >
          ...
          <p className="text-[11px] text-[#94A3B8] leading-snug mt-2">
            ...
            before you commit. <Link href="/blog/solar-loans-nigeria" className="text-amber-600 hover:underline">Full comparison</Link>.
          </p>
        </div>
      )}
    </div>
